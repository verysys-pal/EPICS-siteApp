...
USB1608G_2AO_exec() {
    ...
    # Build macro string
    local MACRO_STR="P=${APPNAME}:,Bi=Bi,Li=Li,Bo=Bo,Lo=Lo,Bd=Bd,Ai=Ai,Ao=Ao,Ct=Counter,Wd=WaveDig,Wg=WaveGen,Pg=PulseGen,Tg=Trig"    
...
USB1608G_2AO_edit() {
    ...
    cd ${OPDIR}
    # args="P=USB1608G_2AO:,Bi=Bi,Li=Li,Bo=Bo,Lo=Lo,Bd=Bd,Ai=Ai,Ao=Ao,Ct=Counter,Wd=WaveDig,Wg=WaveGen,Pg=PulseGen,Tg=Trig"
    export MEDM_MACRO="-macro P=${APPNAME}:,Bi=Bi,Li=Li,Bo=Bo,Lo=Lo,Bd=Bd,Ai=Ai,Ao=Ao,Ct=Counter,Wd=WaveDig,Wg=WaveGen,Pg=PulseGen,Tg=Trig"
...
measCompDigitalIO8_exec() {
    ...
    cd ${OPDIR}    
    export MEDM_MACRO="-macro P=${APPNAME}:,Bi=Bi,Li=Li,Bo=Bo,Lo=Lo,Bd=Bd"
    export MEDM_FONT='-displayFont fixed'
